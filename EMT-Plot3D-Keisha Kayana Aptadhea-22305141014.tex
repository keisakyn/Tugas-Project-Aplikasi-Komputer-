...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-001.png}
\begin{eulerprompt}
>plot3d("x^2+x*sin(y)",-5,5,0,6*pi):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-003.png}
...
>plot3d("x^2+y^2"):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-004.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-005.png}
\begin{eulercomment}
...
grafik. fscale: skala ke nilai fungsi (defaultnya adalah \textless{}fscale).\\
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-007.png}
\begin{eulercomment}
Plot terlihat selalu ke bagian tengah kubus plot. Anda dapat
memindahkan bagian tengah dengan parameter\\
center.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-009.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-010.png}
\begin{eulerprompt}
>function f(r) := exp(-r/2)*cos(r); ...
>plot3d("f(x^2+y^2)",>polar,scale=[1,1,0.4],r=pi,frame=3,zoom=4):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-012.png}
\begin{eulerprompt}
>plot3d("x^2+1",a=-1,b=1,rotate=2,grid=5):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-013.png}
\begin{eulerprompt}
>plot3d("sqrt(25-x^2)",a=0,b=5,rotate=1):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-014.png}
\begin{eulerprompt}
>plot3d("x*sin(x)",a=0,b=6pi,rotate=2):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-015.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-016.png}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-017.png}
\begin{eulerprompt}
>plot3d("exp(x*y)",angle=100°,>contour,color=green):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-020.png}
\begin{eulerprompt}
>plot3d("x^2-y^2",0,1,0,1,angle=220°,level=-1:0.2:1,color=redgreen):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-021.png}
\begin{eulercomment}
...
Selain itu, kita menghamparkan kisi-kisi dengan 10 interval di setiap
arah.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-024.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-025.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-030.png}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-031.png}
\begin{eulerprompt}
>c=1; d=1;
>plot3d("((x^2+y^2-c^2)^2+(z^2-1)^2)*((y^2+z^2-c^2)^2+(x^2-1)^2)*((z^2+x^2-c^2)^2+(y^2-1)^2)-d",r=2,<frame,>implicit,>user): 
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-032.png}
\begin{eulerprompt}
>plot3d("x^2+y^2+4*x*z+z^3",>implicit,r=2,zoom=2.5):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-033.png}
\eulerheading{Memplot Data 3D Sama seperti plot2d, plot3d menerima data. Untuk}
\begin{eulercomment}
objek 3D, Anda perlu menyediakan matriks nilai x, y, dan\\
z, atau tiga fungsi atau ekspresi fx(x,y), fy(x,y), fz(x,y).
...
>scale=1.4,height=50°):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-034.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-036.png}
\begin{eulercomment}
Dengan lebih banyak upaya, kita bisa menghasilkan banyak permukaan.\\
Dalam contoh berikut ini, kita membuat tampilan berbayang dari bola
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-038.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-039.png}
\begin{eulerprompt}
>t=linspace(0,4pi,1000); plot3d(cos(t),sin(t),t/2pi,>wire, ...
>linewidth=3,wirecolor=blue):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-040.png}
\begin{eulerprompt}
>X=cumsum(normal(3,100)); ...
> plot3d(X[1],X[2],X[3],>anaglyph,>wire):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-043.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-044.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-045.png}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-048.png}
\begin{eulerprompt}
>Z=intrandom(5,100,6); v=zeros(5,6); ...
>loop 1 to 5; v[#]=getmultiplicities(1:6,Z[#]); end; ...
>columnsplot3d(v',scols=1:5,ccols=[1:5]):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-049.png}
...
>level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-050.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-053.png}
\begin{eulercomment}
Berikut ini adalah plot 3D dari gambar di atas yang diputar
mengelilingi sumbu-z. Kita mendefinisikan fungsi, yang menggambarkan
objek.
\end{eulercomment}
\begin{eulerprompt}
>function f(x,y,z) ...
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-054.png}
\eulerheading{Plot 3D Khusus}
\begin{eulercomment}
Fungsi plot3d memang bagus untuk dimiliki, tetapi tidak memenuhi semua
kebutuhan. Di samping rutinitas\\
yang lebih mendasar, Anda bisa mendapatkan plot berbingkai dari objek
apa pun yang Anda sukai. Meskipun Euler bukan program 3D, namun dapat
menggabungkan beberapa objek dasar. Kita mencoba memvisualisasikan
parabola dan garis singgungnya.
\end{eulercomment}
\begin{eulerprompt}
>function myplot ...
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-055.png}
\begin{eulerprompt}
>framedplot("myplot",[0.1,1,0,1,0,1],height=0,angle=-45°, ...
>center=[0,0,-0.7],zoom=5):
\end{eulerprompt}
\eulerimg{19}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-056.png}
\begin{eulercomment}
...
>myplot(x,y,z):
\end{eulerprompt}
\eulerimg{30}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-057.png}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-058.png}
...
pengguna, dan memanggil Povray untuk mengurai file-file ini. 

Nama file default adalah current.pov, dan direktori defaultnya adalah
eulerhome(), biasanya c:\textbackslash{}Users\textbackslash{}Username\textbackslash{}Euler. Povray menghasilkan
sebuah file PNG, yang dapat dimuat oleh Euler ke dalam notebook. 
...
koordinat X,Y,Z dalam matriks, termasuk garis level opsional. 

Fungsi ini memulai raytracer secara otomatis, dan memuat adegan ke
dalam notebook Euler. Selain pov3d(), ada banyak fungsi yang
menghasilkan objek Povray. Fungsi-fungsi ini mengembalikan string,
yang berisi kode Povray untuk objek. Untuk menggunakan fungsi-fungsi
ini, mulai file Povray dengan povstart(). Kemudian gunakan
writeln(...) untuk menulis objek ke file scene. Terakhir, akhiri file
dengan povend(). 

Secara default, raytracer akan dimulai, dan PNG akan dimasukkan ke
...
\end{eulerprompt}
\eulerimg{30}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-059.png}
\begin{eulerprompt}
>pov3d("x^2+y^2",zoom=3);
\end{eulerprompt}
\eulerimg{25}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-060.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-061.png}
\begin{eulercomment}
...
>  <fscale,zoom=3.8);
\end{eulerprompt}
\eulerimg{25}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-062.png}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-063.png}
\begin{eulercomment}
...
pembuatan objek, lihat contoh berikut. Perhatikan bahwa plot3d
menskalakan plot, sehingga sesuai dengan kubus satuan.
\end{eulercomment}
\begin{eulerprompt}
...
>  w=500,h=300);
\end{eulerprompt}
\eulerimg{16}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-064.png}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulercomment}
Persamaan permukaannya adalah [x,y,Z]. Kita dapat menghitung dua
turunan terhadap x dan y dari persamaan ini dan mengambil h a sil
perkalian silang sebagai normal
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-065.png}
\begin{eulercomment}
...
menghitung normal. Pertama, tiga fungsi untuk koordinat sebagai\\
ekspresi simbolis
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{18}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-066.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{25}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-067.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{25}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-068.png}
...
>povend;
\end{eulerprompt}
\eulerimg{25}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-069.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{25}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-070.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{25}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-071.png}
...
>povend();
\end{eulerprompt}
\eulerimg{25}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-072.png}
\begin{eulerprompt}
>povstart(angle=70°,height=50°,zoom=4);
\end{eulerprompt}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{25}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-073.png}
...
>povend();
\end{eulerprompt}
\eulerimg{25}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-074.png}
...
\end{eulerprompt}
\eulerimg{24}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-075.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-076.png}
...
>povend(h=320,w=480);
\end{eulerprompt}
\eulerimg{17}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-077.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{25}{images/EMT-Plot3D-Keisha Kayana Aptadhea-22305141014-078.png}
