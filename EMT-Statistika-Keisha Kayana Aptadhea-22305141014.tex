...
\begin{eulercomment}
Dalam modul ini, kami mendemonstrasikan plot statistik utama, tes dan
distribusi dalam Euler.
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-001.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-002.png}
\begin{eulercomment}
...
\end{eulercomment}
\begin{eulerprompt}
>(T[,1]+T[,2])/2 // titik tengah dari setiap intervalhe midpoint of each interval
\end{eulerprompt}
\begin{euleroutput}
          157.5 
          161.5 
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-003.png}
\eulerheading{Tables}
\begin{eulercomment}
...
file, kita dapat mencetak tabel.\\
Kita dapat menentukan ctok, tok, dll. atau menggunakan daftar Tabel.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-004.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-009.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2}(\frac{t-m}{d})^2}\ dt.
\]
...
dengan rata-rata dan deviasi yang sama.
...
biasa, Euler memetakan vektor ke fungsi ini.\\
Dengan demikian kita mendapatkan plot semua distribusi chi-kuadrat
dengan derajat 5 hingga 30 dengan mudah dengan cara berikut.
\end{eulercomment}
\begin{eulerprompt}
>plot2d("qchidis(x,(5:5:50)')",0,50):
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-010.png}
\begin{eulercomment}
Euler memiliki fungsi-fungsi yang akurat untuk mengevaluasi
distribusi-distribusi. Mari kita\\
periksa chidis() dengan sebuah integral. Penamaannya diusahakan untuk
konsisten.
...
\end{eulerprompt}
\begin{eulercomment}
Kesalahan ini sangat kecil sehingga kita hanya bisa melihatnya setelah
melakukan iterasi yang sangat banyak.
\end{eulercomment}
\begin{eulerprompt}
>columnsplot(getmultiplicities(1:6,wrongdice(1,1000000))):
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{eulercomment}
Untuk partai, kita menggunakan serangkaian nama.
\end{eulercomment}
\begin{eulerprompt}
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-012.png}
\begin{eulercomment}
...
dalam satu plot menggunakan figure.\\
Kita dapat menambahkan vektor kolom pada setiap plot.
\end{eulercomment}
\begin{eulerprompt}
>figure(2,1);  ...
...
>figure(0):
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-014.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-015.png}
\begin{eulercomment}
...
dat. Kolom-kolom akan diperluas untuk label-label kolom, jika perlu.
\end{eulercomment}
\begin{eulerprompt}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-017.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-022.png}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulercomment}
Kemudian ekstrak nomor unik tersebu dalam v
\end{eulercomment}
\begin{eulerprompt}
>vu:=unique(v)
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-023.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-024.png}
\begin{eulercomment}
...
jelas.\\
nt-t distribution and exponential distribution.
\end{eulercomment}
\begin{eulerprompt}
>x=normal(1,100); plot2d(x,x+rotright(x),>points,style=".."):
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-026.png}
\begin{eulercomment}
...
ai yang terdistribusi normal cenderung lebih kecil pada ujung yang
ekstrem.
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-027.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-028.png}
\begin{eulercomment}
Sebagai contoh lain, kami membaca survei tentang siswa, usia mereka,
usia orang tua mereka, dan jumlah\\
saudara kandung dari sebuah file.\\
...
implementasi yang sangat singkat dan efisien. Mari kita coba fungsi
ini.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-030.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-031.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-032.png}
\eulerheading{Tests}
\begin{eulercomment}
...
Carlo untuk menguji statistik.\\
Hasilnya seharusnya hampir sama. Parameter \textgreater{}p menginterpretasikan
...
\end{euleroutput}
\begin{eulercomment}
Fungsi test() membutuhkan nilai rata-rata, deviasi, jumlah data, dan
nilai rata-rata untuk diuji. \\
Sekarang mari kita periksa dua pengukuran untuk mean yang sama. Kita
tolak hipotesis bahwa kedua pengukuran tersebut memiliki nilai r a t a
- r a t a yang sama, jika hasilnya \textless{} 0,05.\\
\end{eulercomment}
\begin{eulerttcomment}
 mendapatkan nilai berikut, yang kami masukkan ke dalam uji chi-square
\end{eulerttcomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-033.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
t a yang sama, jika hasilnya \textless{} 0,05.\\
\end{eulercomment}
\begin{eulerttcomment}
 mendapatkan nilai berikut, yang kami masukkan ke dalam uji chi-square
\end{eulerttcomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-034.png}
\begin{eulercomment}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-035.png}
\begin{eulercomment}
Clear the data.
\end{eulercomment}
\begin{eulerprompt}
...
Buku catatan ini cocok untuk Anda jika Anda sudah terbiasa dengan R,
tetapi perlu mengetahui perbedaan sintaks EMT\\
dan R.

Kami mencoba memberikan gambaran umum tentang hal-hal yang jelas dan
kurang jelas yang perlu Anda ketahui. Selain itu, kami juga akan
membahas caracara untuk bertukar data di antara kedua sistem.
\end{eulercomment}
\begin{eulercomment}
...
dapat berupa string Unicode.\\
Sebuah string unicode dapat diterjemahkan ke pengkodean lokal dan
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-038.png}
\eulerheading{Daftar}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT-Statistika-Keisha Kayana Aptadhea-22305141014-039.png}
\begin{eulercomment}
